...
<main class="container py-5">
    ...
    <form action="result.php" enctype="multipart/form-data" method="POST">
        ...
        <div class="box bg-white p-4 rounded shadow mt-5">
            ...
            <!-- save btn -->
            <button class="btn btn-primary save position-fixed top-50 start-0 d-none cut-img" type="button"><img src="./assets/images/scissors-icon.svg" alt="scissor icon" class="scissor-icon"></button>
            <!-- download btn -->
